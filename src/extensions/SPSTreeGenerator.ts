import { Vector3, MeshBuilder, Mesh, SolidParticleSystem, Axis, Quaternion, TransformNode, AbstractMesh } from "@babylonjs/core";
...
*/
export var createTree = function(trunkHeight, trunkTaper, trunkSlices, trunkMaterial, boughs, forks, forkAngle, forkRatio, branches, branchAngle, bowFreq, bowHeight, leavesOnBranch, leafWHRatio, leafMaterial, scene) {        
    ...
    _leaves.billboardMode = AbstractMesh.BILLBOARDMODE_ALL; //TransformNode.BILLBOARDMODE_ALL; // carles
    _leaf.dispose(); 
